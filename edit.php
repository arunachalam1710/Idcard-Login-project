...
<body>
    <div class="form">
        <p><a href="dashboard.php">Dashboard</a> | <a  href="insert.php">Insert New Records</a> | <a href="logout.php">Logout</a></p>
        <h1>Update Record</h1>
        <?php
        $status="";
    ...
    $status="Record Update successfully.</br></br<a href='view.php'>View Update Record</a>";
